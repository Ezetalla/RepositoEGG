...
FinSubProceso
Subproceso calcularMuro(superficie Por Referencia, muro Por Referencia)
	
    Definir espesor, largo, alto, cantidad_cemento, cantidad_arena, cantidad_ladrillos, cemento_por_m2,arena_por_m3,ladrillos_por_m2  Como Real
